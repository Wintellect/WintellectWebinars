...
# In YOUR /etc/hosts or c:\windows\system32\drivers\hosts, enter:
# HOST_IP billtrackerprodemo.com
# where HOST_IP your server IP
...
# visit http://billtrackerprodemo.com/, should work but not yet be secure.
