...
# Setup the web app:
/apps/appcode/demo_apps/pypi
pip install -r requirements.txt
python setup.py develop

# Copy and enable the daemon
cp /apps/appcode/demo_apps/pypi/server/pypi.service /etc/systemd/system/
...
cp /apps/appcode/demo_apps/pypi/server/pypi.nginx /etc/nginx/sites-enabled/pypi.nginx
