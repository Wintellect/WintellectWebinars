...
from pypi_secure.data.languages import ProgrammingLanguage
from pypi_secure.data.licenses import License
from pypi_secure.data.maintainers import Maintainer
from pypi_secure.data.package import Package
from pypi_secure.data.releases import Release
...
def do_load_files() -> List[dict]:
    data_path = os.path.abspath(os.path.join(os.path.dirname(__file__),
                                             '../../../../../code/top_10_web_explore/data/pypi-top-100'))
